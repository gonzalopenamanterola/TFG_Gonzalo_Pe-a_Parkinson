...
if len(data) == 0:
    raise ValueError("No se encontraron datos válidos. Verifica la estructura de las carpetas y los archivos CSV.")

# Asegurar dimensiones uniformes con un límite de timesteps
MAX_TIMESTEPS = 5000  # Reducimos el tamaño máximo
...
for sample in data:
    if len(sample) > MAX_TIMESTEPS:
        data_trimmed.append(sample[:MAX_TIMESTEPS])  # Truncamos si es muy largo
    else:
...
# Construcción del modelo Bi-LSTM
...
# Guardar modelo
model.save("modelo_BiLSTM_v1_combinado.keras")
print("Modelo guardado como modelo_BiLSTM_v1_combinado_20_epochs.keras")

# Guardar el escalador
joblib.dump(scaler, "scaler_BiLSTM_v1_combinado.pkl")
print("Escalador guardado como scaler_BiLSTM_v1_combinado_20_epochs.pkl")